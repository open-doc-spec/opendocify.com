---
description: "CLI and product FAQ: install, adoption, profiles vs tags, and the background service."
order: 25
ods:
  profile: "note"
  status: "stable"
...
Spec FAQ (why ODS is designed this way): [FAQ](/docs/faq). Feature catalog: [Features](/docs/features).
...
**No.** Without a root `ods.toml` (`spec = "0.1"`), tools do not rewrite your tree. Plain Markdown is plain Markdown.
