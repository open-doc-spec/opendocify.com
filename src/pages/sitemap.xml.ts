...
const pages = ['/', '/features', '/examples', '/pricing', '/download', '/changelog', '/privacy', '/docs', '/docs/quickstart', '/docs/adoption', '/docs/tooling', '/docs/profiles', '/docs/advanced', '/spec', '/spec/ods/intro', '/spec/ods/keys', '/spec/ods/core', '/spec/ods/profiles', '/spec/ods/graph', '/spec/ods/context', '/spec/ods/indexes', '/spec/ods/assets', '/spec/ods/validation', '/spec/ods/scope', '/spec/okf/intro', '/spec/okf/keys', '/spec/skills/intro', '/spec/skills/keys'];
